...
public class Dashboard extends JFrame implements ActionListener {
	...
	Dashboard(String username){
		...
		Image i5 = i4.getImage().getScaledInstance(65, 80, Image.SCALE_DEFAULT);
		ImageIcon i6 = new ImageIcon(i5);
        l2 = new JLabel(i6);
		l2.setBounds(0, 0, 70, 60);
		p1.add(l2);
		
		l3 = new JLabel("Dashboard");
	...
	public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b13) {
        	...
        	try {
        		...
        		JOptionPane.showMessageDialog(null, "Proper File does not Exist");
        	}
        }
